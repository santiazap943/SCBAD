...
if(isset($_POST['update'])){
	$updateExcepcionPersonal = new ExcepcionPersonal($idExcepcionPersonal, $descripcion, $profesor, $tipo);
	...
	if($_SESSION['entity'] == 'Administrator'){
		$logAdministrator = new LogAdministrator("","Edit Excepcion Personal", "Descripcion: " . $descripcion . ";; Profesor: " . $nameProfesor . ";; Tipo: " . $nameTipo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logAdministrator -> insert();
	}
	else if($_SESSION['entity'] == 'Administrador'){
		$logAdministrador = new LogAdministrador("","Edit Excepcion Personal", "Descripcion: " . $descripcion . ";; Profesor: " . $nameProfesor . ";; Tipo: " . $nameTipo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logAdministrador -> insert();
	}
	else if($_SESSION['entity'] == 'Coordinador'){
		$logCoordinador = new LogCoordinador("","Edit Excepcion Personal", "Descripcion: " . $descripcion . ";; Profesor: " . $nameProfesor . ";; Tipo: " . $nameTipo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Edit ExcepcionPersonal</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/excepcionPersonal/updateExcepcionPersonal.php") . "&idExcepcionPersonal=" . $idExcepcionPersonal ?>" class="bootstrap-form needs-validation"   >
						<div class="form-group">
							...
							<input type="text" class="form-control" name="descripcion" value="<?php echo $updateExcepcionPersonal -> getDescripcion() ?>" required />
						</div>
					<div class="form-group">
