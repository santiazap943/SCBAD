...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Coordinador</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<th nowrap>Clave 
						<?php if($order=="clave" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/coordinador/selectAllCoordinador.php") ?>&order=clave&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="clave" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/coordinador/selectAllCoordinador.php") ?>&order=clave&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						<th nowrap></th>
					...
					foreach ($coordinadors as $currentCoordinador) {
						...
						echo "<td>" . $currentCoordinador -> getClave() . "</td>";
